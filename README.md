...
Sample data:
1, 10, 2010-01-01, 2010-01-03
2, 10, 2010-01-01, 2010-01-03 
3, 11, 2009-01-01, NULL
...
Sample output:
1, 2, 10, 3
...
3) Create an UI:
   ...
   projects of the pair are displayed in data grid with the following columns:
...
```
    ...
    <array>
        ...
        <string>employees.example.com</string>
...
Production
```
xcrun simctl openurl booted examplescheme://employees.example.com/deepLinks/1
```

UAT
```
xcrun simctl openurl booted exampleuatscheme://employeesuat.example.com/deepLinks/1
```

SIT
```
xcrun simctl openurl booted examplesitscheme://employeessit.example.com/deepLinks/1
```

Development
```
xcrun simctl openurl booted exampledevscheme://employeesdev.example.com/deepLinks/1
```
