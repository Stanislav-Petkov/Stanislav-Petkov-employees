...
class I18nError {
  ...
  ///   <tr>
  ///     <td style="width:60px;">bg</td>
  ///     <td>"Не е избран файл"</td>
  ///   </tr>
  ///  </table>
  ///
  String get noFileSelected {
    return customLookup?.noFileSelected ?? _lookup.noFileSelected;
  }
  ...
  String? getString(String key, [Map<String, String>? placeholders]) {
    switch (key) {
      ...
      case I18nErrorKeys.noFileSelected:
...
class I18nErrorLookup {
  ...
  String get noFileSelected {
    return getString(I18nErrorKeys.noFileSelected);
  }
}
...
class Assets {
  /// ![](file:///D:/MacBookProFiles/StudioProjects/employees/assets/images/.git_keep)
  static const String gitKeep = "assets/images/.git_keep";
  /// ![](file:///D:/MacBookProFiles/StudioProjects/employees/assets/values.csv)
  static const String values1 = "assets/values.csv";
}
